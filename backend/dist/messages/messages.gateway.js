...
let MessagesGateway = class MessagesGateway {
    ...
    handleDisconnect(client) { this.onlineUsers.delete(client.id); }
    handleJoinRoom(client, swapRequestId) {
        client.join(swapRequestId);
        return { event: 'joinedRoom', data: swapRequestId };
    }
    handleLeaveRoom(client, swapRequestId) {
    ...
    handleTyping(client, swapRequestId) {
        const userId = this.onlineUsers.get(client.id);
